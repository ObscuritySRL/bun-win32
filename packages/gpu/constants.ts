...
export const CTX_COPY_STRUCTURE_COUNT = 49;
export const CTX_COPY_SUBRESOURCE_REGION = 46;
...
export const CTX_DISPATCH_INDIRECT = 42;
export const CTX_DRAW = 13;
export const CTX_END = 28;
export const CTX_FLUSH = 111;
export const CTX_GENERATE_MIPS = 54;
export const CTX_GET_DATA = 29;
...
export const D3D11_BUFFER_UAV_FLAG_APPEND = 0x2;
...
export const D3D11_MAP_FLAG_DO_NOT_WAIT = 0x10_0000;
...
export const D3D11_RESOURCE_MISC_DRAWINDIRECT_ARGS = 0x10;
...
export const DEV_CHECK_FEATURE_SUPPORT = 33;
...
export const DEV_CREATE_QUERY = 24;
...
export const DXGIFACTORY1_ENUM_ADAPTERS1 = 12;
export const DXGI_ADAPTER_FLAG_SOFTWARE = 0x2;
...
export const DXGI_ERROR_NOT_FOUND = 0x887a_0002;
export const DXGI_ERROR_WAS_STILL_DRAWING = 0x887a_000a;
...
export const E_INVALIDARG = 0x8007_0057;
export const E_OUTOFMEMORY = 0x8007_000e;
...
export const IID_IDXGIFACTORY1 = '770aae78-f26f-4dba-a829-253c83d1b387';
