...
export { elementAt, listMonitors, type MonitorInfo, ownerHwnd, type PointDescription, postClickAt, postClickToHwnd, postDoubleClickAt, postDoubleClickToHwnd, postDragToHwnd, postTripleClickAt, postTripleClickToHwnd, scrollAt, virtualScreen, windowAt } from './coords';
