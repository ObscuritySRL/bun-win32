...
export type { BOOL, BYTE, DWORD, LPWSTR, NULL, VOID, WCHAR, WORD } from '@bun-win32/core';
...
export type PXINPUT_BATTERY_INFORMATION = Pointer;
export type PXINPUT_CAPABILITIES = Pointer;
export type PXINPUT_KEYSTROKE = Pointer;
