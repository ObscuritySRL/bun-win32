...
export type { BOOL, DWORD, HANDLE, HMODULE, LPCSTR, LPCWSTR, LPDWORD, LPSTR, LPVOID, LPWSTR, Nullable as Nullable, Optional as Optional, PDWORD, PVOID } from '@bun-win32/core';
