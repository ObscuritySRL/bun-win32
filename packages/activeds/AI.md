...
Activeds.Preload(['SomeFunctionW', 'AnotherFunction']);
Activeds.Preload('SomeFunctionW');
Activeds.Preload();
```
...
| Need                              | Read                 |
| --------------------------------- | -------------------- |
| Find a method or its MS Docs link | `structs/Activeds.ts` |
...
All documented `Activeds.dll` exports are bound. Each method maps 1:1 to its DLL export. Names, parameter names, and order match Microsoft Docs.
...
Activeds.SomeFunctionW(wide.ptr);
