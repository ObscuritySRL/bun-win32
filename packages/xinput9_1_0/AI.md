# AI Guide for @bun-win32/xinput9_1_0
...
```ts
import Xinput9_1_0, { SomeFlag } from '@bun-win32/xinput9_1_0';

// Methods bind lazily on first call
const result = Xinput9_1_0.SomeFunctionW(arg1, arg2);

// Preload: array, single string, or no args (all symbols)
Xinput9_1_0.Preload(['SomeFunctionW', 'AnotherFunction']);
Xinput9_1_0.Preload('SomeFunctionW');
Xinput9_1_0.Preload();
```
...
| Need                              | Read                     |
| --------------------------------- | ------------------------ |
| Find a method or its MS Docs link | `structs/Xinput9_1_0.ts` |
| Find types, enums, constants      | `types/Xinput9_1_0.ts`   |
| Quick examples                    | `README.md`              |

`index.ts` re-exports the class and all types — import from `@bun-win32/xinput9_1_0` directly.

## Calling Convention

All documented `xinput9_1_0.dll` exports are bound. Each method maps 1:1 to its DLL export. Names, parameter names, and order match Microsoft Docs.
...
Xinput9_1_0.SomeFunctionW(wide.ptr);
...
Xinput9_1_0.SomeFunction(out.ptr);
