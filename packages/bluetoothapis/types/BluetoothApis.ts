...
export type { BOOL, DWORD, HANDLE, HRESULT, LPBYTE, LPCWSTR, LPDWORD, LPVOID, LPWSTR, NULL, NULLABLE, OPTIONAL, PHANDLE, PULONG, PVOID, ULONG, USHORT } from '@bun-win32/core';
