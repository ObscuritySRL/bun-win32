...
class Mscms extends Win32 {
  ...
  public static AssociateColorProfileWithDeviceA(pMachineName: PCSTR | NULL, pProfileName: PCSTR, pDeviceName: PCSTR): BOOL {
  ...
  public static AssociateColorProfileWithDeviceW(pMachineName: PCWSTR | NULL, pProfileName: PCWSTR, pDeviceName: PCWSTR): BOOL {
  ...
  public static CheckBitmapBits(hColorTransform: HTRANSFORM, pSrcBits: PVOID, bmInput: BMFORMAT, dwWidth: DWORD, dwHeight: DWORD, dwStride: DWORD, paResult: PBYTE, pfnCallback: PBMCALLBACKFN | NULL, lpCallbackData: LPARAM): BOOL {
    return Mscms.Load('CheckBitmapBits')(hColorTransform, pSrcBits, bmInput, dwWidth, dwHeight, dwStride, paResult, pfnCallback, lpCallbackData);
  }

  // https://learn.microsoft.com/en-us/windows/win32/api/icm/nf-icm-checkcolors
  public static CheckColors(hColorTransform: HTRANSFORM, paInputColors: PCOLOR, nColors: DWORD, ctInput: COLORTYPE, paResult: PBYTE): BOOL {
    return Mscms.Load('CheckColors')(hColorTransform, paInputColors, nColors, ctInput, paResult);
  }

  // https://learn.microsoft.com/en-us/windows/win32/api/icm/nf-icm-closecolorprofile
  public static CloseColorProfile(hProfile: HPROFILE | 0n): BOOL {
  ...
  public static ColorProfileGetDeviceCapabilities(scope: WCS_PROFILE_MANAGEMENT_SCOPE, targetAdapterID: LUID, sourceID: UINT32, capsType: WCS_DEVICE_CAPABILITIES_TYPE, outputCapabilities: PVOID): HRESULT {
    return Mscms.Load('ColorProfileGetDeviceCapabilities')(scope, targetAdapterID, sourceID, capsType, outputCapabilities);
  }

  // https://learn.microsoft.com/en-us/windows/win32/api/icm/nf-icm-colorprofilegetdisplaydefault
  public static ColorProfileGetDisplayDefault(scope: WCS_PROFILE_MANAGEMENT_SCOPE, targetAdapterID: LUID, sourceID: UINT32, profileType: COLORPROFILETYPE, profileSubType: COLORPROFILESUBTYPE, profileName: LPVOID): HRESULT {
    return Mscms.Load('ColorProfileGetDisplayDefault')(scope, targetAdapterID, sourceID, profileType, profileSubType, profileName);
  }

  // https://learn.microsoft.com/en-us/windows/win32/api/icm/nf-icm-colorprofilegetdisplaylist
  public static ColorProfileGetDisplayList(scope: WCS_PROFILE_MANAGEMENT_SCOPE, targetAdapterID: LUID, sourceID: UINT32, profileList: LPVOID, profileCount: PDWORD): HRESULT {
    return Mscms.Load('ColorProfileGetDisplayList')(scope, targetAdapterID, sourceID, profileList, profileCount);
  }

  // https://learn.microsoft.com/en-us/windows/win32/api/icm/nf-icm-colorprofilegetdisplayuserscope
  public static ColorProfileGetDisplayUserScope(targetAdapterID: LUID, sourceID: UINT32, scope: LPDWORD): HRESULT {
    return Mscms.Load('ColorProfileGetDisplayUserScope')(targetAdapterID, sourceID, scope);
  }
  ...
  public static ConvertColorNameToIndex(hProfile: HPROFILE, paColorName: PCOLOR_NAME, paIndex: PDWORD, dwCount: DWORD): BOOL {
    return Mscms.Load('ConvertColorNameToIndex')(hProfile, paColorName, paIndex, dwCount);
  }

  // https://learn.microsoft.com/en-us/windows/win32/api/icm/nf-icm-convertindextocolorname
  public static ConvertIndexToColorName(hProfile: HPROFILE, paIndex: PDWORD, paColorName: PCOLOR_NAME, dwCount: DWORD): BOOL {
    return Mscms.Load('ConvertIndexToColorName')(hProfile, paIndex, paColorName, dwCount);
  }

  // https://learn.microsoft.com/en-us/windows/win32/api/icm/nf-icm-createcolortransforma
  public static CreateColorTransformA(pLogColorSpace: LPLOGCOLORSPACEA, hDestProfile: HPROFILE, hTargetProfile: HPROFILE | 0n, dwFlags: DWORD): HTRANSFORM {
  ...
  public static CreateColorTransformW(pLogColorSpace: LPLOGCOLORSPACEW, hDestProfile: HPROFILE, hTargetProfile: HPROFILE | 0n, dwFlags: DWORD): HTRANSFORM {
  ...
  public static CreateDeviceLinkProfile(hProfile: PHPROFILE, nProfiles: DWORD, padwIntent: PDWORD, nIntents: DWORD, dwFlags: DWORD, pProfileData: LPVOID, indexPreferredCMM: DWORD): BOOL {
    return Mscms.Load('CreateDeviceLinkProfile')(hProfile, nProfiles, padwIntent, nIntents, dwFlags, pProfileData, indexPreferredCMM);
  }
  ...
  public static CreateProfileFromLogColorSpaceA(pLogColorSpace: LPLOGCOLORSPACEA, pProfile: LPVOID): BOOL {
    return Mscms.Load('CreateProfileFromLogColorSpaceA')(pLogColorSpace, pProfile);
  }

  // https://learn.microsoft.com/en-us/windows/win32/api/icm/nf-icm-createprofilefromlogcolorspacew
  public static CreateProfileFromLogColorSpaceW(pLogColorSpace: LPLOGCOLORSPACEW, pProfile: LPVOID): BOOL {
    return Mscms.Load('CreateProfileFromLogColorSpaceW')(pLogColorSpace, pProfile);
  }

  // https://learn.microsoft.com/en-us/windows/win32/api/icm/nf-icm-deletecolortransform
  public static DeleteColorTransform(hxform: HTRANSFORM): BOOL {
    return Mscms.Load('DeleteColorTransform')(hxform);
  }

  // https://learn.microsoft.com/en-us/windows/win32/api/icm/nf-icm-disassociatecolorprofilefromdevicea
  public static DisassociateColorProfileFromDeviceA(pMachineName: PCSTR | NULL, pProfileName: PCSTR, pDeviceName: PCSTR): BOOL {
  ...
  public static DisassociateColorProfileFromDeviceW(pMachineName: PCWSTR | NULL, pProfileName: PCWSTR, pDeviceName: PCWSTR): BOOL {
  ...
  public static EnumColorProfilesA(pMachineName: PCSTR | NULL, pEnumRecord: PENUMTYPEA, pEnumerationBuffer: PBYTE | NULL, pdwSizeOfEnumerationBuffer: PDWORD, pnProfiles: PDWORD | NULL): BOOL {
    return Mscms.Load('EnumColorProfilesA')(pMachineName, pEnumRecord, pEnumerationBuffer, pdwSizeOfEnumerationBuffer, pnProfiles);
  }

  // https://learn.microsoft.com/en-us/windows/win32/api/icm/nf-icm-enumcolorprofilesw
  public static EnumColorProfilesW(pMachineName: PCWSTR | NULL, pEnumRecord: PENUMTYPEW, pEnumerationBuffer: PBYTE | NULL, pdwSizeOfEnumerationBuffer: PDWORD, pnProfiles: PDWORD | NULL): BOOL {
    return Mscms.Load('EnumColorProfilesW')(pMachineName, pEnumRecord, pEnumerationBuffer, pdwSizeOfEnumerationBuffer, pnProfiles);
  }
  ...
  public static GetColorDirectoryA(pMachineName: PCSTR | NULL, pBuffer: PSTR | NULL, pdwSize: PDWORD): BOOL {
    return Mscms.Load('GetColorDirectoryA')(pMachineName, pBuffer, pdwSize);
  }

  // https://learn.microsoft.com/en-us/windows/win32/api/icm/nf-icm-getcolordirectoryw
  public static GetColorDirectoryW(pMachineName: PCWSTR | NULL, pBuffer: PWSTR | NULL, pdwSize: PDWORD): BOOL {
    return Mscms.Load('GetColorDirectoryW')(pMachineName, pBuffer, pdwSize);
  }

  // https://learn.microsoft.com/en-us/windows/win32/api/icm/nf-icm-getcolorprofileelement
  public static GetColorProfileElement(hProfile: HPROFILE, tag: TAGTYPE, dwOffset: DWORD, pcbElement: PDWORD, pElement: PVOID | NULL, pbReference: PBOOL): BOOL {
    return Mscms.Load('GetColorProfileElement')(hProfile, tag, dwOffset, pcbElement, pElement, pbReference);
  }

  // https://learn.microsoft.com/en-us/windows/win32/api/icm/nf-icm-getcolorprofileelementtag
  public static GetColorProfileElementTag(hProfile: HPROFILE, dwIndex: DWORD, pTag: PTAGTYPE): BOOL {
    return Mscms.Load('GetColorProfileElementTag')(hProfile, dwIndex, pTag);
  }

  // https://learn.microsoft.com/en-us/windows/win32/api/icm/nf-icm-getcolorprofilefromhandle
  public static GetColorProfileFromHandle(hProfile: HPROFILE, pProfile: PBYTE | NULL, pcbProfile: PDWORD): BOOL {
    return Mscms.Load('GetColorProfileFromHandle')(hProfile, pProfile, pcbProfile);
  }

  // https://learn.microsoft.com/en-us/windows/win32/api/icm/nf-icm-getcolorprofileheader
  public static GetColorProfileHeader(hProfile: HPROFILE, pHeader: PPROFILEHEADER): BOOL {
    return Mscms.Load('GetColorProfileHeader')(hProfile, pHeader);
  }

  // https://learn.microsoft.com/en-us/windows/win32/api/icm/nf-icm-getcountcolorprofileelements
  public static GetCountColorProfileElements(hProfile: HPROFILE, pnElementCount: PDWORD): BOOL {
    return Mscms.Load('GetCountColorProfileElements')(hProfile, pnElementCount);
  }

  // https://learn.microsoft.com/en-us/windows/win32/api/icm/nf-icm-getnamedprofileinfo
  public static GetNamedProfileInfo(hProfile: HPROFILE, pNamedProfileInfo: PNAMED_PROFILE_INFO): BOOL {
    return Mscms.Load('GetNamedProfileInfo')(hProfile, pNamedProfileInfo);
  }

  // https://learn.microsoft.com/en-us/windows/win32/api/icm/nf-icm-getps2colorrenderingdictionary
  public static GetPS2ColorRenderingDictionary(hProfile: HPROFILE, dwIntent: DWORD, pPS2ColorRenderingDictionary: PBYTE | NULL, pcbPS2ColorRenderingDictionary: PDWORD, pbBinary: PBOOL): BOOL {
    return Mscms.Load('GetPS2ColorRenderingDictionary')(hProfile, dwIntent, pPS2ColorRenderingDictionary, pcbPS2ColorRenderingDictionary, pbBinary);
  }

  // https://learn.microsoft.com/en-us/windows/win32/api/icm/nf-icm-getps2colorrenderingintent
  public static GetPS2ColorRenderingIntent(hProfile: HPROFILE, dwIntent: DWORD, pBuffer: PBYTE | NULL, pcbPS2ColorRenderingIntent: PDWORD): BOOL {
    return Mscms.Load('GetPS2ColorRenderingIntent')(hProfile, dwIntent, pBuffer, pcbPS2ColorRenderingIntent);
  }

  // https://learn.microsoft.com/en-us/windows/win32/api/icm/nf-icm-getps2colorspacearray
  public static GetPS2ColorSpaceArray(hProfile: HPROFILE, dwIntent: DWORD, dwCSAType: DWORD, pPS2ColorSpaceArray: PBYTE | NULL, pcbPS2ColorSpaceArray: PDWORD, pbBinary: PBOOL): BOOL {
    return Mscms.Load('GetPS2ColorSpaceArray')(hProfile, dwIntent, dwCSAType, pPS2ColorSpaceArray, pcbPS2ColorSpaceArray, pbBinary);
  }

  // https://learn.microsoft.com/en-us/windows/win32/api/icm/nf-icm-getstandardcolorspaceprofilea
  public static GetStandardColorSpaceProfileA(pMachineName: PCSTR | NULL, dwSCS: DWORD, pBuffer: PSTR | NULL, pcbSize: PDWORD): BOOL {
    return Mscms.Load('GetStandardColorSpaceProfileA')(pMachineName, dwSCS, pBuffer, pcbSize);
  }

  // https://learn.microsoft.com/en-us/windows/win32/api/icm/nf-icm-getstandardcolorspaceprofilew
  public static GetStandardColorSpaceProfileW(pMachineName: PCWSTR | NULL, dwSCS: DWORD, pBuffer: PWSTR | NULL, pcbSize: PDWORD): BOOL {
    return Mscms.Load('GetStandardColorSpaceProfileW')(pMachineName, dwSCS, pBuffer, pcbSize);
  }

  // https://learn.microsoft.com/en-us/windows/win32/api/icm/nf-icm-installcolorprofilea
  public static InstallColorProfileA(pMachineName: PCSTR | NULL, pProfileName: PCSTR): BOOL {
  ...
  public static InstallColorProfileW(pMachineName: PCWSTR | NULL, pProfileName: PCWSTR): BOOL {
  ...
  public static IsColorProfileTagPresent(hProfile: HPROFILE, tag: TAGTYPE, pbPresent: PBOOL): BOOL {
    return Mscms.Load('IsColorProfileTagPresent')(hProfile, tag, pbPresent);
  }

  // https://learn.microsoft.com/en-us/windows/win32/api/icm/nf-icm-iscolorprofilevalid
  public static IsColorProfileValid(hProfile: HPROFILE, pbValid: PBOOL): BOOL {
    return Mscms.Load('IsColorProfileValid')(hProfile, pbValid);
  }
  ...
  public static RegisterCMMA(pMachineName: PCSTR | NULL, cmmID: DWORD, pCMMdll: PCSTR): BOOL {
  ...
  public static RegisterCMMW(pMachineName: PCWSTR | NULL, cmmID: DWORD, pCMMdll: PCWSTR): BOOL {
  ...
  public static SetStandardColorSpaceProfileA(pMachineName: PCSTR | NULL, dwProfileID: DWORD, pProfilename: PCSTR): BOOL {
  ...
  public static SetStandardColorSpaceProfileW(pMachineName: PCWSTR | NULL, dwProfileID: DWORD, pProfileName: PCWSTR): BOOL {
  ...
  public static TranslateBitmapBits(
    ...
    pfnCallBack: PBMCALLBACKFN | NULL,
    ulCallbackData: LPARAM,
  ): BOOL {
    return Mscms.Load('TranslateBitmapBits')(hColorTransform, pSrcBits, bmInput, dwWidth, dwHeight, dwInputStride, pDestBits, bmOutput, dwOutputStride, pfnCallBack, ulCallbackData);
  }

  // https://learn.microsoft.com/en-us/windows/win32/api/icm/nf-icm-translatecolors
  public static TranslateColors(hColorTransform: HTRANSFORM, paInputColors: PCOLOR, nColors: DWORD, ctInput: COLORTYPE, paOutputColors: PCOLOR, ctOutput: COLORTYPE): BOOL {
    return Mscms.Load('TranslateColors')(hColorTransform, paInputColors, nColors, ctInput, paOutputColors, ctOutput);
  }

  // https://learn.microsoft.com/en-us/windows/win32/api/icm/nf-icm-uninstallcolorprofilea
  public static UninstallColorProfileA(pMachineName: PCSTR | NULL, pProfileName: PCSTR, bDelete: BOOL): BOOL {
  ...
  public static UninstallColorProfileW(pMachineName: PCWSTR | NULL, pProfileName: PCWSTR, bDelete: BOOL): BOOL {
  ...
  public static UnregisterCMMA(pMachineName: PCSTR | NULL, cmmID: DWORD): BOOL {
  ...
  public static UnregisterCMMW(pMachineName: PCWSTR | NULL, cmmID: DWORD): BOOL {
  ...
  public static WcsCheckColors(hColorTransform: HTRANSFORM, nColors: DWORD, nInputChannels: DWORD, cdtInput: COLORDATATYPE, cbInput: DWORD, pInputData: PVOID, paResult: PBYTE): BOOL {
    return Mscms.Load('WcsCheckColors')(hColorTransform, nColors, nInputChannels, cdtInput, cbInput, pInputData, paResult);
  }
  ...
  public static WcsEnumColorProfiles(scope: WCS_PROFILE_MANAGEMENT_SCOPE, pEnumRecord: PENUMTYPEW, pBuffer: PBYTE, dwSize: DWORD, pnProfiles: PDWORD | NULL): BOOL {
    return Mscms.Load('WcsEnumColorProfiles')(scope, pEnumRecord, pBuffer, dwSize, pnProfiles);
  }

  // https://learn.microsoft.com/en-us/windows/win32/api/icm/nf-icm-wcsenumcolorprofilessize
  public static WcsEnumColorProfilesSize(scope: WCS_PROFILE_MANAGEMENT_SCOPE, pEnumRecord: PENUMTYPEW, pdwSize: PDWORD): BOOL {
    return Mscms.Load('WcsEnumColorProfilesSize')(scope, pEnumRecord, pdwSize);
  }

  // https://learn.microsoft.com/en-us/windows/win32/api/icm/nf-icm-wcsgetcalibrationmanagementstate
  public static WcsGetCalibrationManagementState(pbIsEnabled: LPBOOL): BOOL {
    return Mscms.Load('WcsGetCalibrationManagementState')(pbIsEnabled);
  }
  ...
  public static WcsGetDefaultColorProfile(
    ...
    return Mscms.Load('WcsGetDefaultColorProfile')(scope, pDeviceName, cptColorProfileType, cpstColorProfileSubType, dwProfileID, cbProfileName, pProfileName);
  }
  ...
  public static WcsGetDefaultColorProfileSize(
    ...
    return Mscms.Load('WcsGetDefaultColorProfileSize')(scope, pDeviceName, cptColorProfileType, cpstColorProfileSubType, dwProfileID, pcbProfileName);
  }

  // https://learn.microsoft.com/en-us/windows/win32/api/icm/nf-icm-wcsgetdefaultrenderingintent
  public static WcsGetDefaultRenderingIntent(scope: WCS_PROFILE_MANAGEMENT_SCOPE, pdwRenderingIntent: PDWORD): BOOL {
    return Mscms.Load('WcsGetDefaultRenderingIntent')(scope, pdwRenderingIntent);
  }

  // https://learn.microsoft.com/en-us/windows/win32/api/icm/nf-icm-wcsgetuseperuserprofiles
  public static WcsGetUsePerUserProfiles(pDeviceName: PCWSTR, dwDeviceClass: DWORD, pUsePerUserProfiles: PBOOL): BOOL {
    return Mscms.Load('WcsGetUsePerUserProfiles')(pDeviceName, dwDeviceClass, pUsePerUserProfiles);
  }

  // https://learn.microsoft.com/en-us/windows/win32/api/icm/nf-icm-wcsopencolorprofilea
  public static WcsOpenColorProfileA(pCDMPProfile: PPROFILE, pCAMPProfile: PPROFILE | NULL, pGMMPProfile: PPROFILE | NULL, dwDesireAccess: DWORD, dwShareMode: DWORD, dwCreationMode: DWORD, dwFlags: DWORD): HPROFILE {
  ...
  public static WcsOpenColorProfileW(pCDMPProfile: PPROFILE, pCAMPProfile: PPROFILE | NULL, pGMMPProfile: PPROFILE | NULL, dwDesireAccess: DWORD, dwShareMode: DWORD, dwCreationMode: DWORD, dwFlags: DWORD): HPROFILE {
  ...
  public static WcsTranslateColors(
    ...
    return Mscms.Load('WcsTranslateColors')(hColorTransform, nColors, nInputChannels, cdtInput, cbInput, pInputData, nOutputChannels, cdtOutput, cbOutput, pOutputData);
  }
}
