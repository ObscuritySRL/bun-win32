# AI Guide for @bun-win32/xaudio2_9
...
```ts
import Xaudio2_9, { SomeFlag } from '@bun-win32/xaudio2_9';

// Methods bind lazily on first call
const result = Xaudio2_9.SomeFunctionW(arg1, arg2);

// Preload: array, single string, or no args (all symbols)
Xaudio2_9.Preload(['SomeFunctionW', 'AnotherFunction']);
Xaudio2_9.Preload('SomeFunctionW');
Xaudio2_9.Preload();
```
...
| Need                              | Read                    |
| --------------------------------- | ----------------------- |
| Find a method or its MS Docs link | `structs/Xaudio2_9.ts`  |
| Find types, enums, constants      | `types/Xaudio2_9.ts`    |
| Quick examples                    | `README.md`             |

`index.ts` re-exports the class and all types — import from `@bun-win32/xaudio2_9` directly.

## Calling Convention

All documented `xaudio2_9.dll` exports are bound. Each method maps 1:1 to its DLL export. Names, parameter names, and order match Microsoft Docs.
...
Xaudio2_9.SomeFunctionW(wide.ptr);
...
Xaudio2_9.SomeFunction(out.ptr);
