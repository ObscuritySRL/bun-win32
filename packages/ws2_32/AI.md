...
```ts
import Ws2_32, { SomeFlag } from '@bun-win32/ws2_32';

// Methods bind lazily on first call
const result = Ws2_32.SomeFunctionW(arg1, arg2);

// Preload: array, single string, or no args (all symbols)
Ws2_32.Preload(['SomeFunctionW', 'AnotherFunction']);
Ws2_32.Preload('SomeFunctionW');
Ws2_32.Preload();
```
...
All documented `ws2_32.dll` exports are bound. Each method maps 1:1 to its DLL export. Names, parameter names, and order match Microsoft Docs.
