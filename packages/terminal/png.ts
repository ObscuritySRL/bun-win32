// Minimal PNG encoder for the captured framebuffer. `Bun.deflateSync` returns a
// raw DEFLATE stream, so the IDAT payload is hand-wrapped in a zlib container
// (0x78 0x01 + data + Adler-32 of the unfiltered scanlines).
 ...
 * @example
 * await Bun.write('frame.png', encodePNG(surface.pixels, surface.width, surface.height));
 */
