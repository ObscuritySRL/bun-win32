...
Vssapi.Preload(['SomeFunctionW', 'AnotherFunction']);
Vssapi.Preload('SomeFunctionW');
Vssapi.Preload();
```
...
| Need                              | Read                 |
| --------------------------------- | -------------------- |
| Find a method or its MS Docs link | `structs/Vssapi.ts` |
