...
const CORE_TYPE_SET: ReadonlySet<string> = new Set([
  // number
  'ACCESS_MASK', 'BOOL', 'BOOLEAN', 'BYTE', 'CHAR', 'DWORD', 'HRESULT',
  'INT', 'LONG', 'SHORT', 'UINT', 'ULONG', 'USHORT', 'WCHAR', 'WORD',
  // bigint
  'DWORD_PTR', 'HANDLE', 'HINSTANCE', 'HMODULE', 'HWND',
  'INT_PTR', 'LONG_PTR', 'SIZE_T', 'UINT_PTR', 'ULONG_PTR',
  // derived
  'LPARAM', 'LRESULT', 'WPARAM',
  // Pointer
  'LPBOOL', 'LPBYTE', 'LPCSTR', 'LPCVOID', 'LPCWSTR', 'LPDWORD', 'LPHANDLE',
  'LPSECURITY_ATTRIBUTES', 'LPSTR', 'LPVOID', 'LPWSTR',
  'PBYTE', 'PDWORD', 'PHANDLE', 'PULONG', 'PVOID',
  // special
  'NULL', 'VOID',
]);

// ── C type → FFI type (kept in sync with scripts/audit.ts) ─────────────────

const C_TYPE_TO_FFI: Record<string, string> = {
  // Handles → u64
  HANDLE: 'FFIType.u64', HGLOBAL: 'FFIType.u64', HLOCAL: 'FFIType.u64',
  HMODULE: 'FFIType.u64', HINSTANCE: 'FFIType.u64', HWND: 'FFIType.u64',
  HDC: 'FFIType.u64', HKEY: 'FFIType.u64', HICON: 'FFIType.u64',
  HCURSOR: 'FFIType.u64', HMENU: 'FFIType.u64', HBRUSH: 'FFIType.u64',
  HPEN: 'FFIType.u64', HFONT: 'FFIType.u64', HRGN: 'FFIType.u64',
  HBITMAP: 'FFIType.u64', HPALETTE: 'FFIType.u64', HDESK: 'FFIType.u64',
  HWINSTA: 'FFIType.u64', HHOOK: 'FFIType.u64', HDWP: 'FFIType.u64',
  HMONITOR: 'FFIType.u64', HACCEL: 'FFIType.u64', HPCON: 'FFIType.u64',
  HRSRC: 'FFIType.u64', HCRYPTHASH: 'FFIType.u64', HCRYPTKEY: 'FFIType.u64',
  HCRYPTPROV: 'FFIType.u64', HUSKEY: 'FFIType.u64', HGLRC: 'FFIType.u64',
  SC_HANDLE: 'FFIType.u64', HCERTSTORE: 'FFIType.u64',
  ...
  SIZE_T: 'FFIType.u64', DWORD_PTR: 'FFIType.u64', UINT_PTR: 'FFIType.u64',
  ULONG_PTR: 'FFIType.u64', ULONGLONG: 'FFIType.u64', DWORDLONG: 'FFIType.u64',
  LARGE_INTEGER: 'FFIType.i64', ULARGE_INTEGER: 'FFIType.u64',
  INT_PTR: 'FFIType.i64', LONG_PTR: 'FFIType.i64',
  LRESULT: 'FFIType.i64', LPARAM: 'FFIType.i64', WPARAM: 'FFIType.u64',
  // 32-bit unsigned → u32
  DWORD: 'FFIType.u32', UINT: 'FFIType.u32', ULONG: 'FFIType.u32',
  COLORREF: 'FFIType.u32', ACCESS_MASK: 'FFIType.u32',
  // 32-bit signed
  HRESULT: 'FFIType.i32', BOOL: 'FFIType.i32', INT: 'FFIType.i32', LONG: 'FFIType.i32',
  // 16-bit
  WORD: 'FFIType.u16', USHORT: 'FFIType.u16', ATOM: 'FFIType.u16',
  SHORT: 'FFIType.i16',
  // 8-bit
  BYTE: 'FFIType.u8', BOOLEAN: 'FFIType.u8', CHAR: 'FFIType.u8', UCHAR: 'FFIType.u8',
  // Pointer aliases (explicit)
  PUCHAR: 'FFIType.ptr', LPOVERLAPPED: 'FFIType.ptr',
  LPVOID: 'FFIType.ptr', LPCVOID: 'FFIType.ptr',
  LPCWSTR: 'FFIType.ptr', LPCSTR: 'FFIType.ptr',
  LPWSTR: 'FFIType.ptr', LPSTR: 'FFIType.ptr',
  LPBYTE: 'FFIType.ptr', LPBOOL: 'FFIType.ptr',
  LPDWORD: 'FFIType.ptr', LPHANDLE: 'FFIType.ptr',
  LPSECURITY_ATTRIBUTES: 'FFIType.ptr',
  PVOID: 'FFIType.ptr', PBYTE: 'FFIType.ptr',
  PDWORD: 'FFIType.ptr', PHANDLE: 'FFIType.ptr', PULONG: 'FFIType.ptr',
  // void
  VOID: 'FFIType.void', void: 'FFIType.void',
};

// ── C type → TS type name ──────────────────────────────────────────────────

const C_TYPE_TO_TS: Record<string, string> = {
  // Handles (identity mapping — most map to themselves)
  HANDLE: 'HANDLE', HGLOBAL: 'HGLOBAL', HLOCAL: 'HLOCAL',
  HMODULE: 'HMODULE', HINSTANCE: 'HINSTANCE', HWND: 'HWND',
  HDC: 'HDC', HKEY: 'HKEY', HICON: 'HICON', HCURSOR: 'HCURSOR',
  HMENU: 'HMENU', HBRUSH: 'HBRUSH', HPEN: 'HPEN', HFONT: 'HFONT',
  HRGN: 'HRGN', HBITMAP: 'HBITMAP', HPALETTE: 'HPALETTE',
  HDESK: 'HDESK', HWINSTA: 'HWINSTA', HHOOK: 'HHOOK', HDWP: 'HDWP',
  HMONITOR: 'HMONITOR', HACCEL: 'HACCEL', HPCON: 'HPCON', HRSRC: 'HRSRC',
  HCRYPTHASH: 'HCRYPTHASH', HCRYPTKEY: 'HCRYPTKEY', HCRYPTPROV: 'HCRYPTPROV',
  HUSKEY: 'HUSKEY', HGLRC: 'HGLRC', SC_HANDLE: 'SC_HANDLE',
  HCERTSTORE: 'HCERTSTORE', PCCERT_CONTEXT: 'PCCERT_CONTEXT',
  // Fixed-width ints
  SIZE_T: 'SIZE_T', DWORD_PTR: 'DWORD_PTR', UINT_PTR: 'UINT_PTR',
  ULONG_PTR: 'ULONG_PTR', INT_PTR: 'INT_PTR', LONG_PTR: 'LONG_PTR',
  ULONGLONG: 'ULONGLONG', DWORDLONG: 'DWORDLONG',
  LARGE_INTEGER: 'LARGE_INTEGER', ULARGE_INTEGER: 'ULARGE_INTEGER',
  LRESULT: 'LRESULT', LPARAM: 'LPARAM', WPARAM: 'WPARAM',
  DWORD: 'DWORD', UINT: 'UINT', ULONG: 'ULONG',
  HRESULT: 'HRESULT', BOOL: 'BOOL', INT: 'INT', LONG: 'LONG',
  WORD: 'WORD', USHORT: 'USHORT', SHORT: 'SHORT', ATOM: 'WORD',
  BYTE: 'BYTE', BOOLEAN: 'BOOLEAN', CHAR: 'CHAR',
  ACCESS_MASK: 'ACCESS_MASK', COLORREF: 'COLORREF',
  UCHAR: 'BYTE',
  // void
  VOID: 'void', void: 'void',
  // Pointer aliases
  LPVOID: 'LPVOID', LPCVOID: 'LPCVOID',
  LPCWSTR: 'LPCWSTR', LPCSTR: 'LPCSTR',
  LPWSTR: 'LPWSTR', LPSTR: 'LPSTR',
  PVOID: 'PVOID',
  LPBYTE: 'LPBYTE', LPBOOL: 'LPBOOL',
  LPDWORD: 'LPDWORD', LPHANDLE: 'LPHANDLE',
  LPSECURITY_ATTRIBUTES: 'LPSECURITY_ATTRIBUTES',
  PBYTE: 'PBYTE', PDWORD: 'PDWORD', PHANDLE: 'PHANDLE', PULONG: 'PULONG',
  PUCHAR: 'LPBYTE',
...
function resolveType(cType: string): ResolvedType {
  ...
  if (normalized === '') {
    return { classification: 'unknown', ffiType: 'FFIType.u64', originalCType, tsType: 'unknown' };
  }
  ...
  if (normalized.endsWith('*')) {
    ...
    if (CORE_TYPE_SET.has(lpCandidate)) {
      return { classification: 'core', ffiType: 'FFIType.ptr', originalCType, tsType: lpCandidate };
    }
    ...
    if (CORE_TYPE_SET.has(pCandidate)) {
      return { classification: 'core', ffiType: 'FFIType.ptr', originalCType, tsType: pCandidate };
    }
    return { classification: 'unknown', ffiType: 'FFIType.ptr', originalCType, tsType: lpCandidate };
  }

  if (CORE_TYPE_SET.has(normalized)) {
    const ffi = C_TYPE_TO_FFI[normalized] ?? 'FFIType.u64';
    return { classification: 'core', ffiType: ffi, originalCType, tsType: normalized };
  }
  ...
  // Heuristic: LP*/P* prefixes strongly imply a pointer type.
  if (/^(LP|P)[A-Z]/.test(normalized)) {
    return { classification: 'inferred-pointer', ffiType: 'FFIType.ptr', originalCType, tsType: normalized };
  }

  // Unknown — default to u64 (most Win32 custom types are handles). Flag it.
  return { classification: 'unknown', ffiType: 'FFIType.u64', originalCType, tsType: normalized };
}
...
for (const exportEntry of payload.exports) {
  if (exportEntry.forwardedTo !== null) {
    forwardedExports.push({ forwardedTo: exportEntry.forwardedTo, name: exportEntry.name });
    continue;
  }
  ...
  for (const parameter of exportEntry.parameters) {
    ...
    params.push({ isSalNullable: parameter.isNullable, name: parameter.name, resolved });
